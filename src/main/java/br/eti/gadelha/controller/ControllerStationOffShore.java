...
@RestController
@RequestMapping("/stationOffShore")
@CrossOrigin(origins = "*", maxAge = 3600)
public class ControllerStationOffShore {

    @Autowired
    private final ServiceStationOffShore service;

    public ControllerStationOffShore(RepositoryStationOffShore repository) {
        this.service = new ServiceStationOffShore(repository) {};
    }
